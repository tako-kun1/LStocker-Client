  ...
  Future<void> _saveProduct() async {
    ...
    if (dept == null || !availableDeptIds.contains(dept)) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text('有効なDEPT番号を入力してください')));
      return;
    }
    _selectedDept = dept;
              ...
              children: [
                ...
                TextFormField(
                  ...
                  validator: (v) {
                    ...
                    if (val == null ||
                        !DeptService.getAvailableDeptIds().contains(val)) {
